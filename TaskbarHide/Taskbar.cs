 ...
 *  https://web.archive.org/web/20170604153350/https://www.codeproject.com/Articles/25572/Hiding-the-Taskbar-and-Startmenu-start-orb-in-Wind
 *  
 */
...
namespace TaskbarHide
{
	...
	public static class Taskbar
	{
		...
		private static void SetVisibility(bool show)
		{
            ...
            IntPtr taskBarWnd2 = FindWindow("Shell_SecondaryTrayWnd", null);
            ...
            IntPtr  startWnd = GetVistaStartMenuWnd(taskBarWnd);
            //	}
            //}

            ShowWindow(taskBarWnd, show ? SW_SHOW : SW_HIDE);
            ShowWindow(taskBarWnd2, show ? SW_SHOW : SW_HIDE);
